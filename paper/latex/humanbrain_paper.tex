...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\columnwidth]{fig2_cable_equation.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\columnwidth]{fig3_brain_regions.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\columnwidth]{fig5_scaling_analysis.png}
