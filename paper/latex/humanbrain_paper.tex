...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\columnwidth]{../exports/png/fig4_performance_benchmarks.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\columnwidth]{../exports/png/fig6_biological_accuracy.png}
